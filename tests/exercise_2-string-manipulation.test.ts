...
describe(
  "exercise_2_1_2_advancedGreet",
  { skip: isSkipped(exercise_2_1_2_advancedGreet, []) },
  () => {
    it("works for regular strings", () => {
      assert.equal(exercise_2_1_2_advancedGreet("Peter"), "Hello, Peter!");
      assert.equal(
        exercise_2_1_2_advancedGreet("Mr. Anderson"),
        "Hello, Mr. Anderson!",
      );
    });
...
describe(
  "exercise_2_3_1_countCharacters",
  { skip: isSkipped(exercise_2_3_1_countCharacters, [""]) },
  () => {
...
describe(
  "exercise_2_3_2_advancedCountCharacters",
  { skip: isSkipped(exercise_2_3_2_advancedCountCharacters, ["test"]) },
  () => {
...
describe(
  "exercise_2_2_scream",
  { skip: isSkipped(exercise_2_2_scream, [""]) },
  () => {
    ...
    it("works for multiple words", () => {
      assert.equal(
        exercise_2_2_scream("This is a Sentence"),
        "THIS IS A SENTENCE",
      );
    });
    ...
    it("works with special characters", () => {
      assert.equal(
        exercise_2_2_scream("This_i5 a Sent€nce!?"),
        "THIS_I5 A SENT€NCE!?",
      );
    });
...
describe(
  "exercise_2_4_markTheCenter",
  { skip: isSkipped(exercise_2_4_markTheCenter, ["test"]) },
  () => {
...
describe(
  "exercise_2_5_removePopel",
  { skip: isSkipped(exercise_2_5_removePopel, ["Popel"]) },
  () => {
    ...
    it('returns a copy of the original string, if it does not contain "popel"', () => {
      assert.equal(
        exercise_2_5_removePopel("This grass is green"),
        "This grass is green",
      );
    });
    ...
    it('replaces "popel" with "foo" in a sentence', () => {
      assert.equal(
        exercise_2_5_removePopel("This popel is green"),
        "This foo is green",
      );
    });
...
describe(
  "exercise_2_6_getTagInnerHTML",
  { skip: isSkipped(exercise_2_6_getTagInnerHTML, ["test"]) },
  () => {
